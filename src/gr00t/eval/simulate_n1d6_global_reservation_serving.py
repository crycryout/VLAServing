...
MODEL_NAMES = (
    ...
    "GR00T-N1.6-fractal",
    "gr00t_n1d6-libero",
    "gr00t_n1d6-libero-rel-action-false-tune-false-30k",
)

# GR00T N1.6 bridge, step=1, torch.compile median full E2E.
SERVICE_MS = 43.8
PRIORITY_GAMMA = 1.35
...
class AutoHorizonParams:
    # Fitted from the official GR00T N1.5 AutoHorizon runs used earlier as the
    # GR00T-side horizon simulator.
